...
import cv2
import time
from VILP.env_runner.utils import resize_images
...
class RobomimicVilpRunner(BaseImageRunner):
    """
    ...
    def run(self, policy: BaseImagePolicy):
        ...
        for chunk_idx in range(n_chunks):
            ...
            while not done:
                ...
                agentview_image = np_obs_dict['agentview_image']
                robot0_eye_in_hand_image = np_obs_dict['robot0_eye_in_hand_image']
                agentview_image = resize_images(agentview_image, 96,96)
                robot0_eye_in_hand_image = resize_images(robot0_eye_in_hand_image, 96,96)
