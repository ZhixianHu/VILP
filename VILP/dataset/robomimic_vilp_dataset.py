...
from VILP.model.normalizer import LinearNormalizer, SingleFieldLinearNormalizer
...
class RobomimicVilpDataset(BaseImageDataset):
    def __init__(self,
            shape_meta: dict,
            dataset_path: str,
            horizon=1,
    ...
    def __getitem__(self, idx: int) -> Dict[str, torch.Tensor]:
        ...
        for key in self.rgb_keys:
            ...
            before_resize = np.moveaxis(data[key][T_slice],-1,1
